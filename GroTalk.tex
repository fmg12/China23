...
\hypersetup{pdftitle={IOP Beijing seminar 11/2023 by F. Malte Grosche},
  pdfsubject={IOP 11/23},
...
{NiS$_2$, Bi-III, CeSb$_2$} \vspace{-2ex}

%% \subtitle
%% {Presentation Subtitle} % (optional)

\author[IOP 11/2023]{F. M. Grosche} % (optional, use only with lots of authors)
